...
import { Loader2, Check, Copy, ExternalLink, CheckCircle2, AlertCircle } from "lucide-react";
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button variant="secondary" onClick={() => copy(authData?.authUrl, "auth_url")} disabled={!authData?.authUrl}>
                        {copied === "auth_url" ? <Check className="size-4" /> : <Copy className="size-4" />}
                        Copy
                      </Button>
                    </div>
                  </div>
                ...
                <div className="text-center py-4">
                  ...
                  <div className="bg-sidebar p-4 rounded-lg mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {copied === "login_url" ? <Check className="size-4" /> : <Copy className="size-4" />}
                      </Button>
                      <Button
                        size="sm"
                        variant="ghost"
                  ...
                  <div className="bg-primary/10 p-4 rounded-lg">
                    ...
                    <div className="flex items-center justify-center gap-2">
                      ...
                      >
                        {copied === "user_code" ? <Check className="size-4" /> : <Copy className="size-4" />}
                      </Button>
                    </div>
                  </div>
                </div>
