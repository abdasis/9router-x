...
export default function useTailscaleInstall() {
  ...
  const handleInstall = async (onConnected) => {
  ...
  return {
    tsInstalled, setTsInstalled,
    tsInstalling, setTsInstalling,
    tsInstallLog, setTsInstallLog,
    tsSudoPassword, setTsSudoPassword,
